...
// TX: fcarrier=928.325MHz dev=  1.600kHz br=  4.800kBit/s pwr= 15.0dBm
// RX: fcarrier=928.325MHz bw=  7.200kHz br=  4.800kBit/s
...
__reentrantb void ax5043_set_registers(void) __reentrant
{
	...
	radio_write8(AX5043_REG_MAXRFOFFSET0,        0xAE);
...
{
	radio_write8(AX5043_REG_TMGRXAGC,                 0x0B);
...
const uint32_t __code axradio_phy_chanfreq[1] = { 0x23b46e47 };
const uint8_t __code axradio_phy_chanpllrnginit[1] = { 0x07 };
...
const int32_t __code axradio_phy_maxfreqoffset = 3594;
...
const uint32_t __code axradio_framing_ack_timeout = 22; // 31.5ms in wtimer0 units (640Hz)
...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 686, 649, 727 };// 20.920ms, 19.790ms, 22.169ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 700, 626, 782 }; // 21.348ms, 19.088ms, 23.846ms
const uint32_t __code axradio_sync_slave_rxtimeout = 943; // 28.8ms, maximum duration of a packet
